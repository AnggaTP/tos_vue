<template>
  <div class="container">
    ...
    <div class="box">
      ...
      <ul>
        <li>
          <span class="fa fa-fort-awesome"></span> Basecamp : Wana Wisata Air
        ...
        <li>
          <span class="fa fa-envelope"></span> Email : pacetraftingtos@gmail.com
        </li>
      </ul>
    </div>
    <div class="box">
      ...
      <ul>
        ...
        <li>
          <span class="fa fa-phone"></span> 085156244623 (OFFICE WA CHAT ONLY)
        </li>
      </ul>
    </div>
  </div>
